...
//! interchange path matrix is inside a metro system the analog for the successor metrix for a graph: item *ij*
//! tells which is the next interchange, or terminal station to reach the destionation from the current
//! starting point.
//!
//!
